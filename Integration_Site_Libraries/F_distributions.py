...
def distributions():
    ...
    for library in libraries:
        os.makedirs("7_distributions/"+library, exist_ok=True)
        ...
        for end in ["RL", "LR"]:
            output_dir = "7_distributions/" + library + "/" + end + ".csv"
    ...
    libraries = ["target-A", "target-B"]
    for library in libraries:
        input_dir_RL = "7_distributions/" + library + "/RL.csv"
        input_dir_LR = "7_distributions/" + library + "/LR.csv"
        output_dir_2 = "7_distributions/" + library + "/average.csv"
